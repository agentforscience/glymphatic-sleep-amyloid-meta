...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PAPER-SPECIFIC TERMS (glymphatic / sleep / amyloid meta-analysis)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Exposure strata
\newcommand{\stage}{\textsc{N3-Stage}\xspace}
\newcommand{\spectral}{\textsc{SWA-Spectral}\xspace}
\newcommand{\tst}{\textsc{TST}\xspace}
\newcommand{\se}{\textsc{SE}\xspace}
\newcommand{\waso}{\textsc{WASO}\xspace}

% Cohort families
\newcommand{\berkeley}{\textsc{Berkeley}\xspace}
\newcommand{\agewell}{\textsc{Age-Well}\xspace}
\newcommand{\mayo}{\textsc{Mayo MCSA}\xspace}
\newcommand{\mars}{\textsc{MARS}\xspace}
\newcommand{\afour}{\textsc{A4}\xspace}
\newcommand{\aibl}{\textsc{AIBL}\xspace}
\newcommand{\blsa}{\textsc{BLSA}\xspace}

% Datasets
\newcommand{\sleepedf}{\textsc{Sleep-EDF Expanded}\xspace}
